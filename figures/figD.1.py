...
mock_joint_sv = np.concatenate((summaries_for_cov['fps'], 
                                ...
                                np.repeat(summaries_for_cov['pure_sm2'], 7, axis=-1),
                               np.repeat(summaries_for_cov['curvature'], 256, axis=-1)),axis=1)

labels = ['FPS', 'FPDF', 'SM1', 'SM2', 'Curv.']
positions = [128, 128*3, 128*5, 128*7, 128*9]
